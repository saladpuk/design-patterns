...
**ลูฟี่**: อ๋อคุ้นๆละ พอทำแบบนั้นมันจะทำให้เราไม่ต้องไปแก้ไข class เดิมเลย แล้วเราก็เรียก class เดิมว่า `Element` ใช่ปะ **ช็อปเปอร์** (สรุปเจ้ากวางนั้นชื่อช็อปเปอร์นี่เอง)  
