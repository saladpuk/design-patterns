...
ซึ่งอิคิวซังก็ได้อธิบายต่อว่า `Facade` คือ class ธรรมดา 1 ตัวนี้แหละ แต่มันจะช่วยไปจัดการเรื่องยากๆทั้งหมดให้เรา แล้วเมื่อไหร่ที่เราจะเรียกใช้งานเรื่องยากๆพวกนั้น มันก็จะมี interface ง่ายๆให้เราเรียกใช้
...
จากที่ว่ามาจะเห็นว่าขั้นตอนเยอะๆด้านหลังนั้น client ไม่มีความจำเป็นต้องรู้ สิ่งที่เขาต้องรู้มีแค่อย่างเดียวคือ ถ้าต้องการอัพโหลดไฟล์ให้เรียก Upload() ก็พอ นี้แหละคือประโยชน์ของ `Facade`
