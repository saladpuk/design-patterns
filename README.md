...
> **อ่านก่อน**  
Repo นี้กำลังค่อยๆอัพเดทเรื่อยๆ ตอนนี้เฉลี่ยวันละ 1 pattern  
หากต้องการช่วยแก้ไข รบกวน fork ออกไปแก้แล้วทำ pull request เข้ามาจะเป็นพระคุณมากครับ  
หากสงสัย/อธิบายตรงไหนผิด ตั้งเป็น Issue ไว้ก็ได้  
หนังสือด้านล่างผมไม่ได้เขียน แต่ผมเอารูปเขามาใช้เลยใส่เครดิตให้เขาเฉยๆ จะซื้อไม่ซื้อก็แล้วแต่ศรัทธาเลยละกัน ส่วนตัวผมว่าอ่านแล้วก็สนุกดี
