...
เจ้าพวกขั้นต่างวุ่นวายๆที่ว่ามานี่แหละ ลองคิดดูสิถ้าเราต้องสร้าง object จาก class ที่ว่านี้ขึ้นมา มันจะทำให้ client code ของเราวุ่นวายขนาดไหน
...
แต่แค่ new House() ขึ้นมา มันยังไม่จบเท่านั้นละ เช่น เราต้องไปคอยกำหนดอีกว่า บ้านจะมีกำแพงกี่ฝั่ง, มี่กี่ชั้น, ใช้ประตูอะไร, หน้าต่างจะเป็นยังไง และต้องไปสร้างหลังคาให้มันด้วย (เนี่ยแหละ complex object)

แต่ปัญหาของมันไม่ได้มีอยู่แค่นี้ เพราะถ้าโปรแกรมของเราเริ่มต้องการบ้านแบบอื่นๆบ้างละ เช่น บ้านไซต์ใหญ่กว่าปรกติ, มีสนามหญ้าด้วย, มีโรงรถ, มีสระว่ายน้ำ, มีรูปปั้นสวยๆประดับบ้าน แค่คิดก็ปวดหัวละในการไปสร้าง object บ้านแต่ละแบบ

จากที่ว่ามาเราก็อาจจะไปสร้าง subclass เพื่อทำหน้าที่กำหนดบ้านแต่ละประเภทที่ว่ามา ตามรูปด้านล่าง

![img](assets/builder/problem1.png)

ซึ่งการทำแบบนี้กำยังมีปัญหาอยู่ดี เช่นอยู่มาวันหนึ่งบ้านจะต้องมีระเบียงด้วย มันก็จะทำให้เราก็ต้องไปแก้ไข subclass พวกนั้นให้รองรับเรื่องระเบียงด้วย จากภาพคือเพิ่มระเบียง 1 เรื่องแต่ต้องไปแก้ 4 subclass แล้วถ้าเรามี subclass เยอะๆละ ... แค่คิดก็ปวดตับละ

งั้นเรามาลองวิธีที่ไม่ต้องไปวุ่นว่ายกับ subclass ดูบ้างซิ คือลองทำให้ `House class` รองรับบ้านทุกรูปแบบเลย โดยแค่ส่ง parameter เข้ามาก็พอ ตามรูปด้านล่าง

![img](assets/builder/problem2.png)

วิธีนี้ใครเคยทำบ้างยกมือโหน่ย XD

ซึ่งข้อเสียของวิธีนี้คือ มันมี parameter มากเกินความจำเป็น สำหรับบ้านบางประเภทก็ไม่ได้ต้องการ parameter บางตัว ทำให้ parameter ส่วนใหญ่ที่ส่งเข้ามาก็ไม่มีประโยชน์ แต่มันบังคับให้เรา**ต้อง**ส่งไปด้วย

แล้วเราจะแก้ไขปัญหาพวกนี้ยังไงดี
...
และ `HouseBuilder` จะเป็นคนดูแลขั้นตอน (method) ในการสร้าง house object ทั้งหมดให้เราเอง เช่น WoodenHouseBuilder สำหรับสร้างบ้านไม้
...
* WoodenyHouseBuilder ภายใน method ของมันก็จะ implement ว่าให้สร้างบ้านขึ้นมาจากไม้
* BrickHouseBuilder ภายใน method ของมันก็จะ implement ว่าให้สร้างบ้านขึ้นมาจากอิฐ
* DiamonHouseBuilder ภายใน method ของมันก็จะ implement ว่าให้สร้างบ้านขึ้นมาจากเพชร
...
แต่การมีแค่ Builder แค่นี้มันยังไม่จบนะ เพราะ builder ก็เปรียบเสมือนชนชั้นแรงงานที่คอยสร้างบ้านให้เรา 

ถ้าเรามีแค่ Builder มันจะทำให้เวลาเราจะสร้างบ้านเราต้องไปเขียนโค้ดคอยเรียก method ของ builder แต่ละแบบเอง เช่นอยากได้บ้านไม้ แต่มีประตูบ้านที่เป็นอิฐ เราก็ต้องไปเขียนเรียก method ในการสร้างบ้านจาก WoodenHouseBuilder และตอนสร้างประตูเราก็ต้องไปเรียก method ในการสร้างประตูจาก BrickHouseBuilder เอาเอง ซึ่งถ้าเขียนโค้ดลักษณะนี้มันก็ยังวุ่นวายอยู่ดี
...
(จินตนาการง่ายๆ คนคุมการสร้างบ้านรู้ว่าเราอยากได้บ้านแบบไหน แต่เขาสร้างไม่เป็น เลยทำให้ต้องไปเรียกใช้คนงานมาสร้างแบบต่างๆ ซึ่งคนงานจะรู้ว่าถ้าอยากได้บ้านไม้ต้องสร้างยังไง หรือ อยากได้ประตูอิฐจะต้องสร้างยังไง)
